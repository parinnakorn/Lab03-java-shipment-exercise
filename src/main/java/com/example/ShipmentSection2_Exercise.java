...
//  ชื่อนักศึกษา : นายปริญญ์นกร อยู่แท้กูล
//  รหัสนักศึกษา : 673380277-1
// ╚══════════════════════════════════════════════════════════╝
//
//  โจทย์:
...
class Shipment {
    ...
    public String toString() {
        return String.format("[%s] %5.2f กก. | %-8s | %,9.2f บาท", trackingNumber, weightKg, type, calculateCost());  // ← เติมให้ครบ
    }
}
